...
model_answer4 = db.child("model_answers").get().val()[4]['answer']
out_of4 = db.child("model_answers").get().val()[4]['out_of']
keywords4 = db.child("model_answers").get().val()[4]['keywords']
keywords4 = re.findall(r"[a-zA-Z]+", keywords4)

model_answer5 = db.child("model_answers").get().val()[5]['answer']
out_of5 = db.child("model_answers").get().val()[5]['out_of']
keywords5 = db.child("model_answers").get().val()[5]['keywords']
keywords5 = re.findall(r"[a-zA-Z]+", keywords5)

model_answer6 = db.child("model_answers").get().val()[6]['answer']
out_of6 = db.child("model_answers").get().val()[6]['out_of']
keywords6 = db.child("model_answers").get().val()[6]['keywords']
keywords6 = re.findall(r"[a-zA-Z]+", keywords6)

model_answer7 = db.child("model_answers").get().val()[7]['answer']
out_of7 = db.child("model_answers").get().val()[7]['out_of']
keywords7 = db.child("model_answers").get().val()[7]['keywords']
keywords7 = re.findall(r"[a-zA-Z]+", keywords7)

model_answer8 = db.child("model_answers").get().val()[8]['answer']
out_of8 = db.child("model_answers").get().val()[8]['out_of']
keywords8 = db.child("model_answers").get().val()[8]['keywords']
keywords8 = re.findall(r"[a-zA-Z]+", keywords8)

model_answer9 = db.child("model_answers").get().val()[9]['answer']
out_of9 = db.child("model_answers").get().val()[9]['out_of']
keywords9 = db.child("model_answers").get().val()[9]['keywords']
keywords9 = re.findall(r"[a-zA-Z]+", keywords9)

model_answer10 = db.child("model_answers").get().val()[10]['answer']
out_of10 = db.child("model_answers").get().val()[10]['out_of']
keywords10= db.child("model_answers").get().val()[10]['keywords']
keywords10 = re.findall(r"[a-zA-Z]+", keywords10)
...
for each_users_answers in all_answers.each():
    ...
    db.child("answers").child(each_users_answers.key()).update({"result3": result})
     ...
     answer = each_users_answers.val()['a4']
    result = givVal(model_answer4, keywords4, answer, out_of4)
    print("Marks : " + str(result))
    db.child("answers").child(each_users_answers.key()).update({"result4": result})

     answer = each_users_answers.val()['a5']
    result = givVal(model_answer5, keywords5, answer, out_of5)
    print("Marks : " + str(result))
    db.child("answers").child(each_users_answers.key()).update({"result5": result})

     answer = each_users_answers.val()['a6']
    result = givVal(model_answer6, keywords6, answer, out_of6)
    print("Marks : " + str(result))
    db.child("answers").child(each_users_answers.key()).update({"result6": result})

     answer = each_users_answers.val()['a7']
    result = givVal(model_answer7, keywords7, answer, out_of7)
    print("Marks : " + str(result))
    db.child("answers").child(each_users_answers.key()).update({"result7": result})

     answer = each_users_answers.val()['a8']
    result = givVal(model_answer8, keywords8, answer, out_of8)
    print("Marks : " + str(result))
    db.child("answers").child(each_users_answers.key()).update({"result8": result})

     answer = each_users_answers.val()['a9']
    result = givVal(model_answer9, keywords9, answer, out_of9)
    print("Marks : " + str(result))
    db.child("answers").child(each_users_answers.key()).update({"result9": result})

     answer = each_users_answers.val()['a10']
    result = givVal(model_answer10, keywords10, answer, out_of10)
    print("Marks : " + str(result))
    db.child("answers").child(each_users_answers.key()).update({"result10": result})
